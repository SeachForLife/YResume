...
public class AutoLayoutUtils {
    ...
    public static void setSize(Activity act, boolean hasStatusBar, int designWidth, int designHeight){
        ...
        AutoLayoutUtils.displayWidth=width;
        AutoLayoutUtils.displayHeight=height;

        AutoLayoutUtils.designWidth=designWidth;
        AutoLayoutUtils.designHeight=designHeight;

        double displayDiagonal=Math.sqrt(Math.pow(AutoLayoutUtils.displayWidth, 2)+Math.pow(AutoLayoutUtils.displayHeight, 2));
        double designDiagonal=Math.sqrt(Math.pow(AutoLayoutUtils.designWidth, 2)+Math.pow(AutoLayoutUtils.designHeight, 2));
        AutoLayoutUtils.textPixelsRate=displayDiagonal/designDiagonal;
    }
    ...
    public static void auto(View view){
        ...
        AutoLayoutUtils.autoTextSize(view);
        AutoLayoutUtils.autoSize(view);
        AutoLayoutUtils.autoPadding(view);
        AutoLayoutUtils.autoMargin(view);
